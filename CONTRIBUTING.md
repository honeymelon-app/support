...
2. If not, [create a new bug report](../../issues/new?template=bug_report.yml)
...
2. If your idea is new, [create a feature request](../../issues/new?template=feature_request.yml)
...
1. Browse [Discussions](../../discussions)
...
See [TRIAGE.md](.github/TRIAGE.md) for detailed triage guidelines.
...
❌ Vague wishes without context
❌ Demands without rationale
❌ Features that conflict with app vision
❌ Duplicate requests without new insights
...
- Check [SUPPORT.md](SUPPORT.md) for support guidelines
- Browse [Discussions](../../discussions) for community Q&A
- Review [existing issues](../../issues) for similar questions

## License

By contributing to this repository (through issues, discussions, or other means), you agree that your contributions will be available under the same [MIT License](LICENSE) that covers this repository.
